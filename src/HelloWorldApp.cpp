...
@{
*/
static const CYIString LOG_TAG("HelloWorldApp");
...
//! [UserInit]
    ...
    CYISceneView *pSceneViewMain = GetSceneManager()->LoadScene("HelloWorld_MainComp.layout", CYISceneManager::SCALE_FIT, CYISceneManager::V_ALIGN_CENTER, CYISceneManager::H_ALIGN_CENTER);
    ...
    m_pSpinAnimation->CompletedForward.Connect(*this, &HelloWorldApp::OnSpinAnimationCompleted, YI_CONNECTION_ASYNC);
